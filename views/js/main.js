...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImage.src = "images/pizza_opt.png";
...
var resizePizzas = function(size) {
  ...
  //this function takes the size we want to convert the pizzas to, and calculate particular width and update it to the randompizzacontainer class
  var getPizzas = document.querySelectorAll(".randomPizzaContainer");
  var pizzaLength = getPizzas.length;
...
document.addEventListener('DOMContentLoaded', function() {
   var cols = 8;
   var s = 256;
   //getting the no of pizzas according to screen height
